...
void LED_AZUL()
{
    for (int LED_AZUL = 0; LED_AZUL < 3; LED_AZUL++)
    {
        ...
        npSetLED(4, 0, 0, 255); // ligar
        npWrite();
        sleep_ms(125);

        npSetLED(3, 0, 0, 255); // ligar
        npWrite();
        sleep_ms(125);

        npSetLED(2, 0, 0, 255); // ligar
        npWrite();
        sleep_ms(125);
...
void LED_TRIPLO_AZUL()
{
    for (int LED_TRIPLO_AZUL = 0; LED_TRIPLO_AZUL < 2; LED_TRIPLO_AZUL++)
    {
        ...
        npSetLED(13, 0, 0, 255); // ponto
        npWrite();
        sleep_ms(1000);

        npSetLED(14, 0, 0, 255); // Ligar
        npWrite();
        sleep_ms(175);

        npSetLED(13, 0, 0, 255); // Ligar
        npWrite();
        sleep_ms(175);
...
int main()
{
    ...
    while (true)
    {
        LED_VERMELHO(); // função para LED VERMELHO

        npClear();
        sleep_ms(500);

        LED_AZUL();// função para LED AZUL

        npClear();
        sleep_ms(1000);

        PrimeiraInstancia();// Inicia LEDS azul e vermelho de primerio momento
        LED_TRIPLO_VERMELHO(); // Vermelho com Branco

        npClear();
        sleep_ms(500);

        LED_TRIPLO_AZUL(); // Azul com Branco
